...
const useStyles = makeStyles(theme => ({
  ...
  ol: ({className, depth}) => {
    const listStyleType = className === 'contains-task-list' ? 
      'none' :
...
const components = {
  ...
  p: (() => {
    const P = props => <Typography {...props} variant="body1" paragraph={true} />;
    return memo(P);
  })(),
  h1: (() => {
  ...
  h2: (() => {
    const H2 = props => <Typography {...props} id={props.children} variant="h2" />
    H2.propTypes = {
      children: PropTypes.any
    };
    return memo(H2);
  ...
  h3: (() => {
    const H3 = props => <Typography {...props} id={props.children} variant="h3" />
    H3.propTypes = {
      children: PropTypes.any
    };
    return memo(H3);
  ...
  h4: (() => {
    const H4 = props => <Typography {...props} id={props.children} variant="h4" />
    H4.propTypes = {
      children: PropTypes.any
    };
    return memo(H4);
  ...
  h5: (() => {
    const H5 = props => <Typography {...props} id={props.children} variant="h5" />
    return memo(H5);
  })(),
  h6: (() => {
    const H6 = props => <Typography {...props} id={props.children} variant="h6" />
    return memo(H6);
  })(),
  blockquote: (() => {
  ...
  table: (() => {
    const T = props => <TableContainer component={Paper}><Table {...props} size="small"/></TableContainer>;
    return memo(T);
  })(),
  tr: (() => {
  ...
  hr: Divider,
  img: ((props) => {
    return (props.width && props.height) ? <Image {...props} /> : <img {...props} />
  }),
  input: (() => {
    const Input = props => {
